...
namespace UnityEngine.EventSystems
{
    ...
    public class CustomInputModule : PointerInputModule
    {
        ...
        public void HandleMousEvents(PointerEventData pointerData, GameObject newTarget)
        {
            HandlePointerExitAndEnter(pointerData, newTarget);
        }
